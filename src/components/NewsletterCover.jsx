...
export default function NewsletterCover({ pdfUrl, coverImg, alt = 'Bülten Kapağı' }) {
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState(false)

  // Determine cover image URL (if not directly passed, derive from pdfUrl if standard)
  const resolvedCover = coverImg || (pdfUrl ? pdfUrl.replace('/newsletter/newsletter-', '/newsletter/covers/cover-').replace('.pdf', '.jpg') : null)
