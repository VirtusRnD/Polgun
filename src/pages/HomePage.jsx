...
// Hero görselleri
const HERO_IMAGES = [
        { title: 'Frenzy Waterpark', location: 'İstanbul', img: frenzy },
        { title: 'Seignosse Atlantic Park', location: 'Antalya', img: seignosse },
        { title: 'Rixos KAEC', location: 'Varşova', img: rixosKaec },
        { title: 'Pantheon Waterpark', location: 'Dubai', img: pantheon },
        { title: 'The Land of Legends', location: 'Bali', img: theLandOfLegends },
        { title: 'SClub Resort Hotel Aqua Park', location: 'Cancun', img: sClub },
        { title: 'Kunuku Aqua Resort', location: 'Miami', img: kunuku },
        { title: 'Güral Premier', location: 'Sydney', img: guralPremier },
        { title: 'Mövenpick Resort', location: 'Varşova', img: movenpick },
        { title: 'SY Hotel', location: 'Dubai', img: syHotelAntalya },
        { title: 'Delphin Palace', location: 'Antalya', img: delphinPalace },
        { title: 'Nirvana Cosmopolitan', location: 'Fiji', img: nirvana },
        { title: 'Maxeria Blue', location: 'İspanya', img: maxeria },
        { title: 'Fantazia Resort Marsa Alam', location: 'İspanya', img: fantazia },
        { title: 'Pickalbatros Sungo Club', location: 'Miami', img: pickalbatros },
        { title: 'Aquila Rithymn a Beach', location: 'Bali', img: aquila },
        { title: 'Ethno Hotels', location: 'Sydney', img: ethno },
