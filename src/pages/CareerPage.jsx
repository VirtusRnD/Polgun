        ...
        <div className="max-w-[var(--layout-max)] mx-auto px-6 lg:px-12 w-full z-10">
          <div className="max-w-2xl text-left">
            <h1 className="text-5xl lg:text-7xl font-black leading-tight tracking-tight">
              <span className="text-[#22ABE6]">{t('career.title', { defaultValue: 'Polgün\'de Kariyer' }).split(' ')[0]}</span> <br />
              <span className="text-white">{t('career.title', { defaultValue: 'Polgün\'de Kariyer' }).split(' ').slice(1).join(' ') || 'Kariyer'}</span>
            </h1>
