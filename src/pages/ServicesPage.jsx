	...
	const steps = [
		{
			...
			sub: t('services.steps.step1.sub', { defaultValue: 'Product Design & Theming' }),
		...
		},
		{
			...
			sub: t('services.steps.step2.sub', { defaultValue: 'Engineering & Projecting' }),
		...
		},
		{
			...
			sub: t('services.steps.step3.sub', { defaultValue: 'Production' }),
		...
		},
		{
			...
			sub: t('services.steps.step4.sub', { defaultValue: 'Project Management & Shipping' }),
		...
		},
		{
			...
			sub: t('services.steps.step5.sub', { defaultValue: 'Installation & Commissioning' }),
